...
public:
            ...
            this))
    {
        ...
        auto icon_no_audio = Gfx::Bitmap::try_load_from_file("/res/icons/16x16/audio-volume-zero.png");
        auto icon_audio = Gfx::Bitmap::try_load_from_file("/res/icons/16x16/audio-volume-high.png");
