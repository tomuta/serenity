...
{
    FBRect rect {
        .x = static_cast<unsigned>(flush_region.x()),
        .y = static_cast<unsigned>(flush_region.y()),
        .width = static_cast<unsigned>(flush_region.width()),
        .height = static_cast<unsigned>(flush_region.height())
    };
