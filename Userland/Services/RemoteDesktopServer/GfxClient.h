...
class GfxClient : public IPC::Connection<RemoteGfxServerEndpoint, RemoteGfxClientEndpoint, GfxClient, Core::LocalSocket>
...
struct Formatter<RemoteDesktopServer::GfxClient> : Formatter<StringView> {
    void format(FormatBuilder& builder, RemoteDesktopServer::GfxClient const& value)
    {
