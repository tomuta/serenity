...
bool decode(Decoder&, RemoteDesktop::Compositor::Window&);
bool encode(Encoder&, RemoteDesktop::Compositor::WindowFrame const&);
bool decode(Decoder&, RemoteDesktop::Compositor::WindowFrame&);
bool encode(Encoder&, RemoteDesktop::Compositor::WindowGeometry const&);
bool decode(Decoder&, RemoteDesktop::Compositor::WindowGeometry&);
bool encode(Encoder&, RemoteDesktop::Compositor::WindowDirtyRects const&);
bool decode(Decoder&, RemoteDesktop::Compositor::WindowDirtyRects&);
