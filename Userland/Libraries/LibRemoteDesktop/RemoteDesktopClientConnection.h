...
class RemoteDesktopClientConnection : public IPC::Connection<RemoteDesktopServerEndpoint, RemoteDesktopClientEndpoint, RemoteDesktopClientConnection, Core::TCPSocket>
...
public:
    RemoteDesktopClientConnection(NonnullRefPtr<Core::TCPSocket> socket)
        : IPC::Connection<RemoteDesktopServerEndpoint, RemoteDesktopClientEndpoint, RemoteDesktopClientConnection, Core::TCPSocket>(*this, move(socket))
