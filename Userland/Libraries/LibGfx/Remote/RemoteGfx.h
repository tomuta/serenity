...
bool decode(Decoder&, Gfx::Painter::LineStyle&);
bool encode(Encoder&, Gfx::Painter::DrawOp const&);
bool decode(Decoder&, Gfx::Painter::DrawOp&);
bool encode(Encoder&, Gfx::Orientation const&);
bool decode(Decoder&, Gfx::Orientation&);
bool encode(Encoder&, RemoteGfx::BitmapData const&);
bool decode(Decoder&, RemoteGfx::BitmapData&);
bool encode(Encoder&, RemoteGfx::BitmapDiff const&);
bool decode(Decoder&, RemoteGfx::BitmapDiff&);
bool encode(Encoder&, RemoteGfx::PaletteData const&);
bool decode(Decoder&, RemoteGfx::PaletteData&);
